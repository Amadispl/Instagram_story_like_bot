...
def like_stories(username, password, usernames):
    ...
    for follower in usernames:
        ...
        view_story_button = driver.find_element(By.CLASS_NAME, "xy80clv")
        if view_story_button:
            ...
            try:
                like_button = driver.find_element(By.XPATH, '/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/section/div[1]/div/div/div[1]/div[2]/div[3]/div[1]/div[2]/span/div')
                ...
                try:
                    like_button = driver.find_element(By.XPATH, '//*[@id="mount_0_0_t3"]/div/div/div[2]/div/div/div/div[1]/div[1]/section/div[1]/div/div/div[1]/div[2]/div[3]/div[1]/div[2]/span/div/div')
                    # Click on the like button or perform desired action
                    like_button.click()
                    print("Liked the story successfuly!")
                    time.sleep(2)
